...
$vid = $_REQUEST['vid'];
$query = "select * from enter where vid='$vid'";
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Visitor Check In/Out List</h4>
                            </div>
                            <div class="content table-responsive table-full-width">
                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="visitor-list-report.php?vid=<?php echo $rec['vid']; ?>"><?php echo $rec['vid']; ?></a></td>
                                            <td><?php echo $rec['cindate']; ?></td>
                                            <td><?php echo $rec['cintime']; ?></td>
                                            <td><?php echo $rec['couttime']; ?></td>
                                        </tr>
