...
$cintime=mysql_real_escape_string($_POST['cintime']);
			
									

mysql_query ("insert into enter(vid,cindate,cintime) values ('$vid','$cindate','$cintime')");
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Visitor Check IN</h4>
                            </div>
                            <?php 
			if($suces_msg=="done")
			{
			echo"<br/><table style='border:solid 3px #009900;border-radius:5px;' align='center' width='40%'>
			<tr><td  align='center' height='25px' style='text-decoration:none; color:#009900; font-size:14px'> Visitor Check in Added successfully.</td></tr>
			</table><br/>";
			}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="time" class="form-control" placeholder="Room Number" name="cintime">
                                            </div>
                                        </div>
                                    </div>
