...
mysql_query ("insert into visitors(id,vname,idno,sname,rollno,relationships,mobile,date) values ('$id','$vname','$idno','$sname','$rollno','$relationships','$mobile','$date')");
...
<div class="wrapper">
    <div class="sidebar" data-color="blue" data-image="assets/img/sidebar-8.jpg">
    ...
    <div class="main-panel">
        ...
        <div class="content">
			...
			<tr><td  align='center' height='25px' style='text-decoration:none; color:#009900; font-size:14px'> Visitor Added successfully.</td></tr>
			</table><br/>";
			}
 									...
 									<div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php
												 $result = mysql_query("SELECT max(id)as max FROM visitors");
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Visitor Name" name="vname">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
